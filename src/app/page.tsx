...
export default function Home() {
  ...
  />
            ...
            <div className="relative z-10 w-full">
              ...
              <p className="max-w-xs text-3xl font-semibold leading-tight">Menerjemahkan persoalan hukum menjadi pekerjaan yang tertata, teliti, dan dapat dipertanggungjawabkan.</p>
